...
class HistoriaNutricionForm(forms.ModelForm):
    # Campos display para mostrar información del paciente
    display_nombre_paciente = forms.CharField(label="Nombre del Paciente", required=False, disabled=True)
    display_cedula_paciente = forms.CharField(label="Cédula", required=False, disabled=True)
    display_edad_paciente = forms.CharField(label="Edad", required=False, disabled=True)
    display_genero_paciente = forms.CharField(label="Género", required=False, disabled=True)
    display_fecha_nac_paciente = forms.CharField(label="Fecha de Nacimiento", required=False, disabled=True)
    display_telefono_paciente = forms.CharField(label="Teléfono", required=False, disabled=True)
    
    # Campo para la dirección del paciente (obtenido de la relación con paciente)
    direccion = forms.CharField(label="Dirección", required=False, widget=forms.Textarea(attrs={'rows': 2}))
    ...
    def __init__(self, *args, **kwargs):
        ...
        if paciente:
            ...
            self.fields['display_cedula_paciente'].initial = paciente.numero_documento
            self.fields['display_edad_paciente'].initial = paciente.edad
            self.fields['display_genero_paciente'].initial = paciente.get_genero_display()
            self.fields['display_fecha_nac_paciente'].initial = paciente.fecha_nacimiento.strftime('%d/%m/%Y') if paciente.fecha_nacimiento else 'N/A'
            telefono_principal = paciente.telefonos.filter(es_principal=True).first()
            self.fields['display_telefono_paciente'].initial = telefono_principal.numero if telefono_principal else 'N/A'
        
        # Usamos el layout en formato de líneas
        self.helper.layout = Layout(
            Fieldset('Datos del Paciente', Row( Column('display_nombre_paciente', css_class='col-md-6'), Column('display_fecha_nac_paciente', css_class='col-md-3'), Column('display_cedula_paciente', css_class='col-md-3'), ), Row( Column('display_edad_paciente', css_class='col-md-2'), Column('display_genero_paciente', css_class='col-md-2'), Column('display_telefono_paciente', css_class='col-md-3'), Column('numero_historia_clinica', css_class='col-md-5'), ), css_class='border rounded p-3 mb-3 bg-light'),
            Fieldset('Información Adicional (Nutrición)', Row( Column('ceca', css_class='col-md-3'), Column('mencion', css_class='col-md-3'), Column('semestre', css_class='col-md-3'), Column('otros_basicos', css_class='col-md-3'), ), Row( Column('es_estudiante', css_class='col-md-3 form-check'), Column('es_empleado', css_class='col-md-3 form-check'), Column('es_docente', css_class='col-md-3 form-check'), ), css_class='border rounded p-3 mb-3'),
            ...
            Fieldset('Hábitos Psicológicos', Row( Column('hab_medicamentos', 'hab_cafeicos', 'hab_sueno', 'hab_cigarros', 'hab_oh', css_class='col-md-6 border-end'), Column('hab_apetito', 'hab_act_fisica', css_class='col-md-6') ), css_class='border rounded p-3 mb-3'),
            ...
            Fieldset('Examen Funcional', Row( Column('func_masticacion', css_class='col-auto form-check'), Column('func_disfagia', css_class='col-auto form-check'), Column('func_nauseas', css_class='col-auto form-check'), Column('func_vomitos', css_class='col-auto form-check'), Column('func_pirosis', css_class='col-auto form-check'), Column('func_rge', css_class='col-auto form-check'), Column('func_periodos_menstruales', css_class='col-auto form-check'), css_class='d-flex flex-wrap' ), Row( Column('func_micciones', css_class='col-md-4'), Column('func_evacuaciones', css_class='col-md-4'), ), css_class='border rounded p-3 mb-3'),
            ...
            Fieldset('Datos Autonométricos', Row( Column('antropo_fecha', css_class='col-sm-6 col-md-3'), Column('antropo_peso_usual', css_class='col-sm-6 col-md-3'), Column('antropo_talla', css_class='col-sm-6 col-md-3'), Column('antropo_imc', css_class='col-sm-6 col-md-3'), ), Row( Column('antropo_peso_max', css_class='col-sm-6 col-md-3'), Column('antropo_peso_min', css_class='col-sm-6 col-md-3'), Column('antropo_peso_rcom', css_class='col-sm-6 col-md-3'), Column('antropo_peso_graso', css_class='col-sm-6 col-md-3'), ), Row( Column('antropo_peso_magro', css_class='col-sm-6 col-md-3'), Column('antropo_porc_grasa', css_class='col-sm-6 col-md-3'), Column('antropo_porc_grasa_rcom', css_class='col-sm-6 col-md-3'), ), Row( Column('antropo_circ_brazo', css_class='col-sm-6 col-md-3'), Column('antropo_circ_cintura', css_class='col-sm-6 col-md-3'), Column('antropo_circ_cadera', css_class='col-sm-6 col-md-3'),), Row( Column('antropo_pliegue_triceps', css_class='col-sm-6 col-md-3'), Column('antropo_pliegue_subescapular', css_class='col-sm-6 col-md-3'), Column('antropo_pliegue_muslo_anterior', css_class='col-sm-6 col-md-3'), Column('antropo_pliegue_pantorrilla', css_class='col-sm-6 col-md-3'), ), Row( Column('antropo_pliegue_suprailiaco', css_class='col-sm-6 col-md-3'), Column('antropo_pliegue_abdominal', css_class='col-sm-6 col-md-3'), Column('antropo_suma_pliegues', css_class='col-sm-6 col-md-3'), ), Row( Column('antropo_am', css_class='col-sm-6 col-md-3'), Column('antropo_ag', css_class='col-sm-6 col-md-3'), ), css_class='border rounded p-3 mb-3'),
            Fieldset('Diagnóstico y Requerimiento Nutricional', 'dx_nutricional', Row( Column('req_rct', css_class='col-md-6'), Column('req_kcal_kg', css_class='col-md-6') ), Row( Column('req_cho_porc', css_class='col-md-4'), Column('req_prot_porc', css_class='col-md-4'), Column('req_grasa_porc', css_class='col-md-4') ), Row( Column('req_l', css_class='col-md-2'), Column('req_v', css_class='col-md-2'), Column('req_f', css_class='col-md-2'), Column('req_a', css_class='col-md-2'), Column('req_c', css_class='col-md-2'), Column('req_g', css_class='col-md-2'), ), css_class='border rounded p-3 mb-3'),
            Fieldset('Observaciones y Evolución', Row( Column('observaciones', css_class='col-md-6'), Column('evolucion', css_class='col-md-6'), ), css_class='border rounded p-3 mb-3'),
        )
