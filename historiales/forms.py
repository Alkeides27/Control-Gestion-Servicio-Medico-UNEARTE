...
class HistoriaNutricionForm(forms.ModelForm):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.helper.layout = Layout(
            Fieldset('Información Adicional (Nutrición)', Row( Column('numero_historia_clinica', css_class='col-md-4'), Column('ceca', css_class='col-md-3'), Column('mencion', css_class='col-md-2'), Column('semestre', css_class='col-md-3'), ), Row( Column('es_estudiante', css_class='col-md-3 form-check'), Column('es_empleado', css_class='col-md-3 form-check'), Column('es_docente', css_class='col-md-3 form-check'), Column('otros_basicos', css_class='col-md-3'), ), css_class='border rounded p-3 mb-3'),
